...
<header>
        ...
        <img src="img/logos/logocirculotransparente.png" width="200" alt="logocirculotransparente"/>
        <h1>Creesenti Life Coaching &reg;</h1>
    </div>
    </header>
    <nav> <div className="holder">
        <ul className="holder">
        <li><a className="activo" href="index.html">Página Principal y Contacto</a></li>
        <li><a href="nosotros.html">Quién soy y qué servicios brindo</a></li>
    ...
    <footer>Diseñado por Alejandra Havas -&copy; 2021</footer>
